...
if(strpos($result2, '"seller_message": "Payment complete."' )) {
    echo '|𝘾𝙃𝘼𝙍𝙂𝙀𝘿</span>  </span>𝘾𝘾𝙉:  '.$lista.'</span>  <br>|➤ 𝙍𝙚𝙨𝙥𝙤𝙣𝙨𝙚: $'.$amt.' Charged ✅ |𝘾𝙝𝙚𝙘𝙠𝙚𝙧 𝗕𝗬 <a href="https://t.me/MotuSamusa" class="link">@MotuSamusa</a> <br> |➤ 𝙍𝙚𝙘𝙚𝙞𝙥𝙩: <a href='.$receipturl.'>Here</a><br>|➤ 𝘽𝙔𝙋𝘼𝙎𝙎𝙄𝙉𝙂: '.$x.'<br> <br>';
